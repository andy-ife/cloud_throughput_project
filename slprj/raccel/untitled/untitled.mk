...
MAKECMD         = /usr/local/MATLAB/R2025a/bin/glnxa64/gmake -j 2 -l 2
HOST            = UNIX
BUILD           = yes
SYS_TARGET_FILE = any
...
MODEL                   = untitled
MODULES                 = rtGetNaN.c rt_nonfinite.c untitled.c untitled_capi.c untitled_data.c untitled_tgtconn.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c slsa_sim_common_utils.c main.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = untitled
MAKEFILE                = untitled.mk
MATLAB_ROOT             = /usr/local/MATLAB/R2025a
ALT_MATLAB_ROOT         = /usr/local/MATLAB/R2025a
START_DIR               = /home/goose/Matlab\ Projects/cloud_throughput_project
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 0
COMPUTER                = GLNXA64
BUILDARGS               =  RSIM_SOLVER_SELECTION=1 PCMATLABROOT="/usr/local/MATLAB/R2025a" EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 RSIM_PARAMETER_LOADING=1 OPTS="-DTGTCONN -DIS_SIM_TARGET -DENABLE_SLEXEC_SSBRIDGE=1 -DNRT -DRSIM_PARAMETER_LOADING -DRSIM_WITH_SL_SOLVER -DUSE_LOCALHOST -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DON_TARGET_WAIT_FOR_START=0 -DTID01EQ=0"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 1
ALLOCATIONFCN           = 0
...
ADDITIONAL_LDFLAGS      =  -Wl,--allow-shlib-undefined -Wl,-rpath,/usr/local/MATLAB/R2025a/sys/os/glnxa64
